...
namespace ErgComm.Interfaces
{
    ...
    public interface IErgDriver
    {
        ...
        /// <param name="strokeDataCallback">Callback invoked when new data is available.</param>
        /// <param name="cancellationToken">Token to cancel the streaming.</param>
        Task ConnectAndStreamAsync(string ergId, Action<ErgStatus> statusDataCallback, Action<StrokeData> strokeDataCallback, CancellationToken cancellationToken);
    }
}